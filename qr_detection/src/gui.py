...
class QRDetectionGUI:
    ...
    def __init__(self, root):
        ...
        self.project_root = Path(__file__).resolve().parent.parent.parent  # Up 3 levels to project root
        self.create_widgets()
        ...
        def run():
            try:
                ...
                result = subprocess.run(
                    [sys.executable, "-m", "qr_detection.src.cli"] + list(args),
    ...
    def show_documentation(self):
        """Display documentation from docs folder."""
        doc_path = self.project_root / "docs" / "INTERFACES.md"
