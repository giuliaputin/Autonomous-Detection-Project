...
python main.py image --input data/images/test --log-level DEBUG --show

# Optional live webcam decode debug
python main.py live --model qr_detection/runs/detect/qr_detector_v17/weights/best.pt --log-level DEBUG --fps 5
```

Notes:

- `main.py image` is the recommended first step for controlled tests.
